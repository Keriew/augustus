...
{
    platform_screen_show_error_message_box("Claudius has crashed :(",
        "There was an unrecoverable error in Claudius, which will now close.\n\n"
...
#define GITHUB_ACTIONS_SOURCE_PATH "D:\\a\\claudius\\claudius\\"
