...
static const overlay_menu_entry submenu_risks[] = {
    ...
    { OVERLAY_ENEMY, TR_OVERLAY_ENEMY, CLAUDIUS, NULL },
    { OVERLAY_SICKNESS, TR_OVERLAY_SICKNESS, CLAUDIUS, NULL },
    OVERLAY_MENU_END
};

static const overlay_menu_entry submenu_entertainment[] = {
    { OVERLAY_ENTERTAINMENT, OVERLAY_ENTERTAINMENT, JULIUS, NULL },
    { OVERLAY_TAVERN, TR_OVERLAY_TAVERN, CLAUDIUS, NULL },
    { OVERLAY_THEATER, 0, JULIUS, NULL },
    { OVERLAY_AMPHITHEATER, 0, JULIUS, NULL },
    { OVERLAY_ARENA, TR_OVERLAY_ARENA_COL, CLAUDIUS, NULL },
...
static const overlay_menu_entry submenu_health[] = {
    {OVERLAY_HEALTH, TR_OVERLAY_HEALTH, CLAUDIUS, NULL},
...
static const overlay_menu_entry submenu_commerce[] = {
    {OVERLAY_LOGISTICS, TR_OVERLAY_LOGISTICS, CLAUDIUS, NULL},
    {OVERLAY_FOOD_STOCKS, 0, JULIUS, NULL},
    {OVERLAY_EFFICIENCY, TR_OVERLAY_EFFICIENCY, CLAUDIUS, NULL},
    {OVERLAY_MOTHBALL, TR_OVERLAY_MOTHBALL, CLAUDIUS, NULL},
    {OVERLAY_TAX_INCOME, 0, JULIUS, NULL},
    {OVERLAY_LEVY, TR_OVERLAY_LEVY, CLAUDIUS, NULL},
    {OVERLAY_EMPLOYMENT, TR_OVERLAY_EMPLOYMENT, CLAUDIUS, NULL},
    OVERLAY_MENU_END
};

static const overlay_menu_entry submenu_housing_groups[] = {
    { OVERLAY_HOUSING_GROUPS_TENTS, TR_OVERLAY_HOUSING_TENTS, CLAUDIUS, NULL},
    { OVERLAY_HOUSING_GROUPS_SHACKS,TR_OVERLAY_HOUSING_SHACKS, CLAUDIUS, NULL},
    { OVERLAY_HOUSING_GROUPS_HOVELS,TR_OVERLAY_HOUSING_HOVELS, CLAUDIUS, NULL},
    { OVERLAY_HOUSING_GROUPS_CASAE,TR_OVERLAY_HOUSING_CASAS, CLAUDIUS, NULL},
    { OVERLAY_HOUSING_GROUPS_INSULAE,TR_OVERLAY_HOUSE_INSULAS, CLAUDIUS, NULL},
    { OVERLAY_HOUSING_GROUPS_VILLAS,TR_OVERLAY_HOUSE_VILLAS, CLAUDIUS, NULL},
    { OVERLAY_HOUSING_GROUPS_PALACES,TR_OVERLAY_HOUSE_PALACES, CLAUDIUS, NULL},
    OVERLAY_MENU_END
};

static const overlay_menu_entry submenu_housing[] = {
    { OVERLAY_HOUSING_GROUPS, TR_OVERLAY_BY_GROUP, CLAUDIUS, submenu_housing_groups},
...
static const overlay_menu_entry overlay_menu[] = {
    ...
    { OVERLAY_ROADS, TR_OVERLAY_ROADS, CLAUDIUS, NULL },
    { OVERLAY_DESIRABILITY,0, JULIUS, NULL },
    { OVERLAY_SENTIMENT, TR_OVERLAY_SENTIMENT, CLAUDIUS, NULL },
    { OVERLAY_HOUSING, TR_HEADER_HOUSING, CLAUDIUS, submenu_housing },
    OVERLAY_MENU_END
};
...
{
    if (entry->translation_type == CLAUDIUS) {
