...
typedef enum {
    ...
    TR_BUILDING_WORK_CAMP_STATUS_WAITING,
    TR_BUILDING_WORK_CAMP_STATUS_GETTING_RESOURCES,
    TR_BUILDING_WORK_CAMP_STATUS_DELIVERING_RESOURCES,
    TR_BUILDING_ARCHITECT_GUILD_STATUS_WAITING,
    TR_BUILDING_ARCHITECT_GUILD_STATUS_GOING_TO_WORK,
    TR_BUILDING_ARCHITECT_GUILD_STATUS_WORKING,
