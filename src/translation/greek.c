...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_TITLE, "Επιλογές διαμόρφωσης Claudius"},
	...
	{TR_HOTKEY_TITLE, "Ρύθμιση πλήκτρων συντομεύσεων του Claudius"},
    ...
    {TR_NO_EXTRA_ASSETS_MESSAGE,
        "Τα πρόσθετα στοιχεία του Claudius δεν μπόρεσαν να φορτωθούν.\n"
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "Το savegame που προσπαθείτε να φορτώσετε είναι για μια πιο πρόσφατη έκδοση του Claudius.\nΠαρακαλούμε ενημερώστε τον Claudius στην πιο πρόσφατη έκδοση." },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_TITLE, "Αδυναμία αποθήκευσης του παιχνιδιού" },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_MESSAGE, "Δεν ήταν δυνατή η αποθήκευση του παιχνιδιού.\nΜπορεί να οφείλεται στο γεγονός ότι ο φάκελος όπου το Caesar 3 διατηρεί τα αποθηκευμένα παιχνίδια απαιτεί πρόσβαση διαχειριστή.\nΠαρακαλούμε είτε αλλάξτε το φάκελο του Caesar 3 σε ένα μέρος που δεν απαιτεί πρόσβαση διαχειριστή είτε εκτελέστε το Claudius ως διαχειριστής (δεν συνιστάται)." },
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "Ελέγξτε το αρχείο claudius-log.txt στον κατάλογο Claudius για λεπτομέρειες."},
    ...
    {TR_EDITOR_CHECK_LOG_MESSAGE, "Ελέγξτε το αρχείο claudius-log.txt στον κατάλογο Claudius για λεπτομέρειες."},
