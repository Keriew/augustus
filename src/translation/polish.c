...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_TITLE, "Claudius - konfiguracja" },
    ...
    {TR_HOTKEY_TITLE, "Claudius - konfiguracja skrótów klawiszowych"},
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "Zapisana gra, którą próbujesz załadować, jest zapisana w nowszej wersji Claudiusa. \nUaktualnij Claudiusa do najnowszej wersji." },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_TITLE, "Nie można zapisać gry" },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_MESSAGE, "Nie można zapisać gry.\nMożliwe, że folder, w którym jest zainstalowany Cezar 3, wymaga uprawnień administratora.\nZmień lokalizację folderu Cezara 3 do miejsa, które nie wymaga uprawnień administratora lub uruchom Claudiusa jako administrator (Niezalecane)." },
    ...
    {TR_EDITOR_CHECK_LOG_MESSAGE, "Aby uzyskać szczegółowe informacje, sprawdź plik claudius-log.txt w katalogu Claudius."},
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "Aby uzyskać szczegółowe informacje, sprawdź plik claudius-log.txt w katalogu Claudius."},
