...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_NATIVE_HUT_ALT, "Native hut" },
    {TR_BUILDING_NATIVE_HUT_ALT_DESC, "Some local people live here, carrying on peacefully with their simple lives. They wish only to be left alone." },
