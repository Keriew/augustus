...
static int is_drawable_farmhouse(int grid_offset, int map_orientation)
{
    ...
    if (map_orientation == DIR_TOP && xy == EDGE_X0Y1) {
        return 1;
    }
    if (map_orientation == DIR_RIGHT && xy == EDGE_X0Y0) {
        return 1;
    }
    if (map_orientation == DIR_BOTTOM && xy == EDGE_X1Y0) {
        return 1;
    }
    if (map_orientation == DIR_RIGHT && xy == EDGE_X1Y1) {
        return 1;
    }
    return 0;
}
...
static int is_drawable_farm_corner(int grid_offset)
{
    ...
    int xy = map_property_multi_tile_xy(grid_offset);
    if (map_orientation == DIR_TOP && xy == EDGE_X0Y2) {
        return 1;
    } else if (map_orientation == DIR_RIGHT && xy == EDGE_X0Y0) {
        return 1;
    } else if (map_orientation == DIR_BOTTOM && xy == EDGE_X2Y0) {
        return 1;
    } else if (map_orientation == DIR_LEFT && xy == EDGE_X2Y2) {
        return 1;
    }
    return 0;
}
