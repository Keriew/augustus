...
static translation_string all_strings[] = {
    ...
    {TR_UI_EXTRA_INFORMATION_IN_CART_DEPOT, "Extra information in cart depot setup"},
    ...
    {TR_BUILDING_INFO_DEPOT_SOURCE_SRC, "Src:"},
    {TR_BUILDING_INFO_DEPOT_DESTINATION, "Destination"},
    {TR_BUILDING_INFO_DEPOT_DESTINATION_DST, "Dst:"},
