...
static translation_string all_strings[] = {
    ...
    {TR_HOTKEY_SHOW_OVERLAY_DAMAGE, "show Damage overlay"},
    {TR_HOTKEY_SHOW_OVERLAY_CRIME, "show Crime overlay"},
    {TR_HOTKEY_ROTATE_BUILDING, "Next building rotation"},
    {TR_HOTKEY_ROTATE_BUILDING_BACK, "Previous building rotation"},
    {TR_HOTKEY_SHOW_OVERLAY_PROBLEMS, "show Problems overlay"},
    ...
    {TR_HOTKEY_SHOW_OVERLAY_FOOD_STOCKS, "show Food Stocks overlay"},
    {TR_HOTKEY_SHOW_OVERLAY_ENTERTAINMENT, "show Entertainment overlay" },
    {TR_HOTKEY_SHOW_OVERLAY_SCHOOL, "show Schools overlay" },
    {TR_HOTKEY_SHOW_OVERLAY_LIBRARY, "show Library overlay" },
    {TR_HOTKEY_SHOW_OVERLAY_ACADEMY, "show Academy overlay" },
    {TR_HOTKEY_SHOW_OVERLAY_BARBER, "show Barber overlay" },
    {TR_HOTKEY_SHOW_OVERLAY_BATHHOUSE, "show Baths overlay" },
    {TR_HOTKEY_SHOW_OVERLAY_CLINIC, "show Clinics overlay" },
