...
"appimage")
	...
	;;
"linux")
	mkdir build && cd build && cmake -DAV1_VIDEO_SUPPORT=ON -DCMAKE_BUILD_TYPE=Release $CMAKE_SDL_VERSION ..
	;;
"android")
	mkdir build
	;;
"emscripten")
	...
	;;
*)
	mkdir build && cd build && cmake -DAV1_VIDEO_SUPPORT=ON $CMAKE_SDL_VERSION ..
	;;
esac
