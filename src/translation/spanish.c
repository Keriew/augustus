...
static translation_string all_strings[] = {
    ...
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_ENTERTAINER, "Configurar acceso de personal de entretenimiento" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_EDUCATION, "Configurar acceso de educadores" },
    {TR_TOOLTIP_BUTTON_ROADBLOCK_PERMISSION_MEDICINE, "Configurar acceso de personal de sanidad" },
    ...
    {TR_BUILDING_SAND_PIT_DESC, "Aqui se extrae arena para mezclas de materiales en la construcción de monumentos."},
    ...
    {TR_BUILDING_CONCRETE_MAKER_DESC, "Aquí se mezcla arena con agua y grava para la construcción de macizos monumentos."},
