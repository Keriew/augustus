...
typedef enum {
    ...
    TR_EDITOR_SCENARIO_EVENTS_MINE_COLLAPSED,
    TR_CITY_MESSAGE_TITLE_MINE_COLLAPSED,
    TR_CITY_MESSAGE_TEXT_MINE_COLLAPSED,
    TR_EDITOR_SCENARIO_EVENTS_PIT_COLLAPSED,
    TR_CITY_MESSAGE_TITLE_PIT_COLLAPSED,
    TR_CITY_MESSAGE_TEXT_PIT_COLLAPSED,
    TR_EDITOR_SCENARIO_EVENTS_QUARRY_COLLAPSED,
    TR_CITY_MESSAGE_TITLE_QUARRY_COLLAPSED,
    TR_CITY_MESSAGE_TEXT_QUARRY_COLLAPSED,
