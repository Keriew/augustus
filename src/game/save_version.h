...
typedef enum {
    ...
    SAVE_GAME_LAST_U16_GRIDS = 168,
    SAVE_GAME_LAST_NO_FORMULAS_AND_MODEL_DATA = 169,
    SAVE_GAME_TESTING_VERSION_BUMP_1 = 170,
    SAVE_GAME_TESTING_VERSION_BUMP_2 = 0xab,
    SAVE_GAME_TESTING_VERSION_BUMP_3 = 0xac,
    SAVE_GAME_TESTING_VERSION_BUMP_4 = 0xad,
    SAVE_GAME_TESTING_VERSION_BUMP_5 = 0xae,
    SAVE_GAME_TESTING_VERSION_BUMP_6 = 0xaf,
    SAVE_GAME_TESTING_VERSION_BUMP_7 = 0xb0,
    SAVE_GAME_TESTING_VERSION_BUMP_8 = 0xb1,
    SAVE_GAME_TESTING_VERSION_BUMP_9 = 0xb2
} savegame_version_t;

typedef enum {
    SCENARIO_CURRENT_VERSION = 29,
    ...
    SCENARIO_TESTING_VERSION_BUMP_1 = 20,
    SCENARIO_TESTING_VERSION_BUMP_2 = 21,
    SCENARIO_TESTING_VERSION_BUMP_3 = 22,
    SCENARIO_TESTING_VERSION_BUMP_4 = 23,
    SCENARIO_TESTING_VERSION_BUMP_5 = 24,
    SCENARIO_TESTING_VERSION_BUMP_6 = 25,
    SCENARIO_TESTING_VERSION_BUMP_7 = 26,
    SCENARIO_TESTING_VERSION_BUMP_8 = 27,
    SCENARIO_TESTING_VERSION_BUMP_9 = 28
} scenario_version_t;
