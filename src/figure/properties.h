...
typedef enum {
    ...
    FIGURE_CATEGORY_ALL = FIGURE_CATEGORY_INACTIVE | FIGURE_CATEGORY_CITIZEN | FIGURE_CATEGORY_NATIVE | FIGURE_CATEGORY_HOSTILE |
        FIGURE_CATEGORY_ARMED | FIGURE_CATEGORY_ANIMAL
} figure_category;
