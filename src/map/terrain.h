...
enum {
    ...
    TERRAIN_HIGHWAY_TOP = 0x20000,
    TERRAIN_HIGHWAY_RIGHT = 0x40000,
    TERRAIN_HIGHWAY_LEFT = 0x80000,
    TERRAIN_HIGHWAY_BOTTOM = 0x100000,
    TERRAIN_HIGHWAY = TERRAIN_HIGHWAY_TOP | TERRAIN_HIGHWAY_LEFT | TERRAIN_HIGHWAY_BOTTOM | TERRAIN_HIGHWAY_RIGHT,
    // combined
