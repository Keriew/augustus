...
typedef enum {
    EVENT_STATE_UNDEFINED = -1,
    EVENT_STATE_DISABLED = 0,
    EVENT_STATE_ACTIVE = 1,
    EVENT_STATE_PAUSED = 2
} event_state;
...
typedef struct {
    int32_t id;
    event_state state;
    int32_t repeat_months_min;
    int32_t repeat_months_max;
    int32_t max_number_of_repeats;
    int32_t execution_count;
    int32_t months_until_active;
