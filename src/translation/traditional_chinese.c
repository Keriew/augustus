...
static translation_string all_strings[] = {
    ...
    {TR_NO_EXTRA_ASSETS_MESSAGE, "無法載入Claudius額外資源。\n"
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "請在claudius目錄中查看claudius-log.txt獲取詳細信息"},
    ...
    {TR_WINDOW_INVALID_CAMPAIGN_TEXT, "戰役文件無效。\n請進入Claudius目錄檢查claudius-log.txt日誌查看詳細信息。"},
    ...
    {TR_USER_DIRECTORIES_NOT_SET_UP_TITLE, "沒有設置Claudius玩家目錄"},
    {TR_USER_DIRECTORIES_NOT_SET_UP_TEXT, "你還沒有設置Claudius玩家目錄（遊戲存檔、自定義場景和地圖會保存在這裏）。\n"
                                          "現在進行設置？"},
    {TR_USER_DIRECTORIES_CANCELLED_TITLE, "取消設置用戶文件夾"},
    {TR_USER_DIRECTORIES_CANCELLED_TEXT, "由於沒有設置Claudius玩家目錄，默認使用C3遊戲目錄。\n"
                                         "之後可以在遊戲設置再進行設置。"},
    ...
    {TR_USER_DIRETORIES_WINDOW_USER_PATH, "Claudius玩家目錄"},
    {TR_USER_DIRECTORIES_USER_PATH_CHANGED_TITLE, "Claudius玩家目錄已變更"},
    {TR_USER_DIRECTORIES_USER_PATH_CHANGED_TEXT, "成功修改Claudius玩家目錄。立即復製所有文件？"},
