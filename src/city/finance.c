...
static building_levy_for_type building_levies[] = {
    ...
    {BUILDING_GRAND_TEMPLE_CERES_REWORKED, GRAND_TEMPLE_LEVY_MONTHLY},
    {BUILDING_GRAND_TEMPLE_NEPTUNE_REWORKED, GRAND_TEMPLE_LEVY_MONTHLY},
    {BUILDING_GRAND_TEMPLE_MERCURY_REWORKED, GRAND_TEMPLE_LEVY_MONTHLY},
    {BUILDING_GRAND_TEMPLE_MARS_REWORKED, GRAND_TEMPLE_LEVY_MONTHLY},
    {BUILDING_PANTHEON, PANTHEON_LEVY_MONTHLY},
    {BUILDING_PANTHEON_REWORKED, PANTHEON_LEVY_MONTHLY}, // 20
