...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_PANTHEON_BONUS_DESC, "The Pantheon provides access to your citizens to worship all the gods. Annual festivals are also held here, and religious and cultural building levies are reduced by 25%.\nWhile all the gods are happy enough, the events \"Contaminated water\", \"Iron mine collapsed\" and \"Flooded clay pit\" will not happen."}, // Note to translators: This one changed from the previous version, please update.
