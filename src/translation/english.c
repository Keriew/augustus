...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_MODULE_3_DESC, "Land traders and caravans move faster." },
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_MODULE_4_DESC, "Sea traders move faster." },
