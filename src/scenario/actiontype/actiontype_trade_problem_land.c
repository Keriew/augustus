...
void scenario_event_action_trade_problem_land_init(scenario_action_t *action)
{
    // Nothing to init.
}

int scenario_event_action_trade_problem_land_execute(scenario_action_t *action)
{
