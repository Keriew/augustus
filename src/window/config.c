...
static config_widget ui_widgets_by_category[CATEGORY_UI_COUNT][MAX_WIDGETS] = {
    // General
    {
        ...
        {TYPE_CHECKBOX, CONFIG_UI_EMPIRE_ROUTE_ANIMATIONS, TR_CONFIG_UI_EMPIRE_ROUTE_ANIMATIONS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN},
        //temporarily in general, it should be grouped with other empire-map-related options, but there arent any yet.
        {TYPE_NONE}
    },
    // Scrolling
    {
