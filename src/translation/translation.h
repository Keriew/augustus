...
typedef enum {
    ...
    TR_MAP_EDITOR_PACKAGE_MAP,
    TR_EDITOR_PACKAGE_MAP,
    TR_EDITOR_PACKAGE_MAP_INFO,
    TR_EDITOR_PACKAGE_MAP_SIZE,
    TR_EDITOR_PACKAGE_MAP_CONTINUE,
    TR_WIDGET_DN,
    TR_SIDEBAR_DATE_JUMP_TO_CURRENT,
    TR_CONFIG_FIX_EMPIRE_MAP_DIMENSIONS,
    TR_PAUSE_MENU_PACKAGING_IMPOSSIBLE,
    TRANSLATION_MAX_KEY
} translation_key;
