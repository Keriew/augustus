 ...
 */
typedef enum {
    BUILDING_STORAGE_STATE_ACCEPTING = 0,                   //32
    BUILDING_STORAGE_STATE_NOT_ACCEPTING = 1,               //32
    BUILDING_STORAGE_STATE_GETTING = 2,                     //32

    BUILDING_STORAGE_STATE_ACCEPTING_28 = 12,               //28
    BUILDING_STORAGE_STATE_NOT_ACCEPTING_28 = 20,           //28
    BUILDING_STORAGE_STATE_GETTING_28 = 16,                 //28

    BUILDING_STORAGE_STATE_ACCEPTING_3QUARTERS = 8,         //24
    BUILDING_STORAGE_STATE_NOT_ACCEPTING_3QUARTERS = 11,    //24
    BUILDING_STORAGE_STATE_GETTING_3QUARTERS = 7,           //24

    BUILDING_STORAGE_STATE_ACCEPTING_20 = 13,               //20
    BUILDING_STORAGE_STATE_NOT_ACCEPTING_20 = 21,           //20
    BUILDING_STORAGE_STATE_GETTING_20 = 17,                 //20

    BUILDING_STORAGE_STATE_ACCEPTING_HALF = 3,              //16
    BUILDING_STORAGE_STATE_NOT_ACCEPTING_HALF = 9,          //16
    BUILDING_STORAGE_STATE_GETTING_HALF = 5,                //16

    BUILDING_STORAGE_STATE_ACCEPTING_12 = 14,               //12
    BUILDING_STORAGE_STATE_NOT_ACCEPTING_12 = 22,           //12
    BUILDING_STORAGE_STATE_GETTING_12 = 18,                 //12

    BUILDING_STORAGE_STATE_ACCEPTING_QUARTER = 4,           //8
    BUILDING_STORAGE_STATE_NOT_ACCEPTING_QUARTER = 10,      //8
    BUILDING_STORAGE_STATE_GETTING_QUARTER = 6,             //8

    BUILDING_STORAGE_STATE_ACCEPTING_4 = 15,                //4
    BUILDING_STORAGE_STATE_NOT_ACCEPTING_4 = 23,            //4
    BUILDING_STORAGE_STATE_GETTING_4 = 19,                  //4
