...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_GATES_DEFAULT_TO_PASS_ALL_WALKERS, "I portali civili fanno passare tutti i walkers di default"},	
	...
	richiede materiale conservato in un magazzino, manovalanza da un campo di lavoro e architetti da una corporazione di architetti." },										
...
{TR_CITY_WARNING_GOLD_NEEDED, "Questo edificio necessita di oro"},
    ...
    {TR_BUILDING_INFO_DEPOT_SELECT_SOURCE, "Scegli una fonte"},   {TR_BUILDING_INFO_DEPOT_SELECT_DESTINATION, "Scegli una destinazione"},
