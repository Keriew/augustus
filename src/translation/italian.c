...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GARDEN_WALL, "Looped garden wall" }, // FIXME in italiano?
    ...
    {TR_WINDOW_BUILDING_ARENA_NEEDS_LIONS, "Il pubblico si diverte con i normali spettacoli di gladiatori, ma dei leoni migliorerebbero but lions would elevate the spectacle." },
    ...
    {TR_BUILDING_SMALL_MAUSOLEUM_DESC, "In questo mausoleo riposano le generazioni passate delle famiglie più ricche della tua città, nonchè l'invidia di molti fra i vivi." },
    ...
    {TR_BUILDING_THEATRE_UPGRADE_DESC, "Questo teatro in funzione operativo. Lo sviluppo locale ha permesso ai tuoi cittadini di espandere l'edificio, fornendo più posti a sedere." },
    ...
    {TR_CITY_MESSAGE_TEXT_LOOTING, "Un magazzino o granaio è stato saccheggiato da cittadini furiosi e le merci sono state rubate! Il basso morale rende questi incidenti più probabile."},
    ...
    {TR_WINDOW_BUILDING_GOVERNMENT_LARGE_STATUE_WATER_WARNING, "Questa stata apparirebbe persino più grandiose con una fontana funzionante. Forniscile accesso alla cisterna." },
    ...
    {TR_BUILDING_LIGHTHOUSE_NEEDS_WORKERS, "Il Faro non ha tutti i lavoratori di cui ha bisogno per tenere acceso il guoco. Le navi non possono usare la sua luce per arrivare ai nostri porti."},
