...
UiPanelPrimitive::UiPanelPrimitive(
...
void UiPanelPrimitive::draw() const
{
    switch (style_) {
        case UiPanelPrimitiveStyle::Outer:
            draw_outer();
            break;
        case UiPanelPrimitiveStyle::Unbordered:
            draw_unbordered();
            break;
        case UiPanelPrimitiveStyle::Inner:
        default:
            draw_inner();
            break;
    }
...
void UiPanelPrimitive::draw_outer() const
{
...
void UiPanelPrimitive::draw_unbordered() const
{
    int image_base = image_group(GROUP_DIALOG_BACKGROUND);
    int image_y = 0;
    for (int yy = 0; yy < height_blocks_; ++yy) {
...
void UiPanelPrimitive::draw_inner() const
{
