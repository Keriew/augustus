...
typedef enum {
    ...
    TR_BUILDING_INFO_DELIVERY,
    TR_BUILDING_INFO_DELIVERIES,
    TR_BUILDING_INFO_DELIVERY_FROM_ROME,
    TR_BUILDING_INFO_DELIVERIES_FROM_ROME,
    TR_BUILDING_INFO_DELIVERIES_DONE,
    TR_BUILDING_INFO_MONUMENT_MINIMUM,
    TRANSLATION_MAX_KEY
} translation_key;
