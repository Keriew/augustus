...
enum {
    ...
    CITIZEN_N1_BLOCKED = 100,
    CITIZEN_N3_AQUEDUCT = 100,
    CITIZEN_N4_RESERVOIR_CONNECTOR = 100,
    ...
    NONCITIZEN_5_FORT = 5,
    NONCITIZEN_N1_BLOCKED = 100,

    WATER_0_PASSABLE = 0,
    WATER_N1_BLOCKED = 100,
    WATER_N2_MAP_EDGE = 100,
    WATER_N3_LOW_BRIDGE = 0, // Small boats can be added!
