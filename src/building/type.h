...
typedef enum {
    ...
    BUILDING_GRAND_TEMPLE_CERES_REWORKED = 212,
    BUILDING_GRAND_TEMPLE_NEPTUNE_REWORKED = 213,
    BUILDING_GRAND_TEMPLE_MERCURY_REWORKED = 214,
    BUILDING_GRAND_TEMPLE_MARS_REWORKED = 215,
    BUILDING_PANTHEON_REWORKED = 216,
    // helper constants
