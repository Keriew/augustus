...
typedef enum {
    ...
    TR_CONFIG_RANDOMISE_MUSIC_TOOLTIP,
    TR_CONFIG_SPEECH,
    TR_CONFIG_EFFECTS,
    ...
    TR_CONFIG_SHOW_INTRO_VIDEO_TOOLTIP,
    TR_CONFIG_SIDEBAR_INFO,
    TR_CONFIG_SIDEBAR_INFO_TOOLTIP,
    ...
    TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE_TOOLTIP,
    TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE_HOUSES,
    TR_CONFIG_SHOW_WATER_STRUCTURE_RANGE_HOUSES_TOOLTIP,
    TR_CONFIG_SHOW_MARKET_RANGE,
    TR_CONFIG_SHOW_MARKET_RANGE_TOOLTIP,
    TR_CONFIG_SHOW_CONSTRUCTION_SIZE,
    TR_CONFIG_SHOW_CONSTRUCTION_SIZE_TOOLTIP,
    TR_CONFIG_HIGHLIGHT_LEGIONS,
    TR_CONFIG_HIGHLIGHT_LEGIONS_TOOLTIP,
    TR_CONFIG_ROTATE_MANUALLY,
    TR_CONFIG_UI_INVERSE_MAP_DRAG,
    TR_CONFIG_UI_MESSAGE_ALERTS,
    TR_CONFIG_UI_MESSAGE_ALERTS_TOOLTIP,
    TR_CONFIG_UI_SHOW_GRID,
    TR_CONFIG_UI_SHOW_GRID_TOOLTIP,
    TR_CONFIG_UI_SHOW_PARTIAL_GRID_AROUND_CONSTRUCTION,
    TR_CONFIG_UI_SHOW_PARTIAL_GRID_AROUND_CONSTRUCTION_TOOLTIP,
    TR_CONFIG_UI_CLIMATE_GRID_COLORS,
    TR_CONFIG_UI_CLIMATE_GRID_COLORS_TOOLTIP,
    TR_CONFIG_UI_ALWAYS_SHOW_ROTATION_BUTTONS,
    TR_CONFIG_UI_ALWAYS_SHOW_ROTATION_BUTTONS_TOOLTIP,
    ...
    TR_CONFIG_MAX_GRAND_TEMPLES_TOOLTIP,
    TR_CONFIG_INFINITE,
    TR_CONFIG_GODS_EFFECTS,
    TR_CONFIG_GODS_EFFECTS_TOOLTIP,
    TR_CONFIG_JEALOUS_GODS,
    TR_CONFIG_JEALOUS_GODS_TOOLTIP,
    TR_CONFIG_GLOBAL_LABOUR,
    TR_CONFIG_GLOBAL_LABOUR_TOOLTIP,
    TR_CONFIG_SCHOOL_WALKERS,
    TR_CONFIG_RETIRE_AT_60,
    TR_CONFIG_RETIRE_AT_60_TOOLTIP,
    TR_CONFIG_FIXED_WORKERS,
    TR_CONFIG_FIXED_WORKERS_TOOLTIP,
    TR_CONFIG_EXTRA_FORTS,
    TR_CONFIG_WOLVES_BLOCK,
    TR_CONFIG_WOLVES_BLOCK_TOOLTIP,
    TR_CONFIG_DYNAMIC_GRANARIES,
    TR_CONFIG_MORE_STOCKPILE,
    TR_CONFIG_NO_SUPPLIER_DISTRIBUTION,
    TR_CONFIG_NO_SUPPLIER_DISTRIBUTION_TOOLTIP,
    TR_CONFIG_IMMEDIATELY_DELETE_BUILDINGS,
    TR_CONFIG_GETTING_GRANARIES_GO_OFFROAD,
    TR_CONFIG_GETTING_GRANARIES_GO_OFFROAD_TOOLTIP,
    TR_CONFIG_GRANARIES_GET_DOUBLE,
    TR_CONFIG_GRANARIES_GET_DOUBLE_TOOLTIP,
    TR_CONFIG_ALLOW_EXPORTING_FROM_GRANARIES,
    TR_CONFIG_ALLOW_EXPORTING_FROM_GRANARIES_TOOLTIP,
    TR_CONFIG_TOWER_SENTRIES_GO_OFFROAD,
    TR_CONFIG_TOWER_SENTRIES_GO_OFFROAD_TOOLTIP,
    TR_CONFIG_FARMS_DELIVER_CLOSE,
    TR_CONFIG_FARMS_DELIVER_CLOSE_TOOLTIP,
    TR_CONFIG_DELIVER_ONLY_TO_ACCEPTING_GRANARIES,
    TR_CONFIG_DELIVER_ONLY_TO_ACCEPTING_GRANARIES_TOOLTIP,
    TR_CONFIG_ALL_HOUSES_MERGE,
    TR_CONFIG_ALL_HOUSES_MERGE_TOOLTIP,
    TR_CONFIG_WINE_COUNTS_IF_OPEN_TRADE_ROUTE,
    TR_CONFIG_RANDOM_COLLAPSES_TAKE_MONEY,
    TR_CONFIG_RANDOM_COLLAPSES_TAKE_MONEY_TOOLTIP,
    TR_CONFIG_MULTIPLE_BARRACKS,
    TR_CONFIG_MULTIPLE_BARRACKS_TOOLTIP,
    TR_CONFIG_NOT_ACCEPTING_WAREHOUSES,
    TR_CONFIG_NOT_ACCEPTING_WAREHOUSES_TOOLTIP,
    TR_CONFIG_NOT_ACCEPTING_MARKETS,
    TR_CONFIG_NOT_ACCEPTING_MARKETS_TOOLTIP,
    TR_CONFIG_HOUSES_DONT_EXPAND_INTO_GARDENS,
        TR_CONFIG_HOUSES_DONT_EXPAND_INTO_GARDENS_TOOLTIP,
    TR_CONFIG_GP_CH_AUTO_CLEAR_TREES,
    TR_CONFIG_GP_CH_AUTO_CLEAR_TREES_TOOLTIP,
    TR_CONFIG_ROAMERS_DONT_SKIP_CORNERS,
    TR_CONFIG_ROAMERS_DONT_SKIP_CORNERS_TOOLTIP,
    TR_CONFIG_SHOW_MILITARY_SIDEBAR,
    TR_CONFIG_SHOW_MILITARY_SIDEBAR_TOOLTIP,
    TR_CONFIG_DISABLE_RIGHT_CLICK_MAP_DRAG,
    TR_CONFIG_SHOW_MAX_POSSIBLE_PROSPERITY,
    TR_CONFIG_SHOW_MAX_POSSIBLE_PROSPERITY_TOOLTIP,
    TR_CONFIG_AUTO_KILL_ANIMALS,
    TR_CONFIG_AUTO_KILL_ANIMALS_TOOLTIP,
    TR_CONFIG_SHOW_ROAMING_PATH,
    TR_CONFIG_SHOW_ROAMING_PATH_TOOLTIP,
    TR_CONFIG_DRAW_CLOUD_SHADOWS,
    TR_CONFIG_DRAW_CLOUD_SHADOWS_TOOLTIP,
    TR_CONFIG_DRAW_WEATHER,
    TR_CONFIG_DRAW_WEATHER_TOOLTIP,
    TR_CONFIG_ASK_CONFIRMATION_ON_FILE_OVERWRITE,
    TR_CONFIG_ASK_CONFIRMATION_ON_FILE_OVERWRITE_TOOLTIP,
    TR_CONFIG_GATES_DEFAULT_TO_PASS_ALL_WALKERS,
    TR_CONFIG_GATES_DEFAULT_TO_PASS_ALL_WALKERS_TOOLTIP,
    TR_HOTKEY_TITLE,
    TR_HOTKEY_LABEL,
    ...
    TR_CONFIG_GP_CH_DISABLE_INFINITE_WOLVES_SPAWNING_TOOLTIP,
    ...
    TR_CONFIG_DIGIT_SEPARATOR_TOOLTIP,
    ...
    TR_CONFIG_SHOW_DESIRABILITY_RANGE_TOOLTIP,
    TR_CONFIG_SHOW_DESIRABILITY_RANGE_ALL,
    TR_CONFIG_SHOW_DESIRABILITY_RANGE_ALL_TOOLTIP,
    ...
    TR_CONFIG_DRAW_ASCLEPIUS_TOOLTIP,
    TR_BUILDING_NATIVE_HUT_ALT,
    TR_CONFIG_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT,
    TR_CONFIG_WAREHOUSES_GRANARIES_OVER_ROAD_PLACEMENT_TOOLTIP,
    TR_CONFIG_HIGHLIGHT_SELECTED_BUILDING,
    TR_CONFIG_HIGHLIGHT_SELECTED_BUILDING_TOOLTIP,
    ...
    TR_CONFIG_MAX_AUTOSAVE_SLOTS_TOOLTIP,
    ...
    TR_CONFIG_MOVE_SAVINGS_TO_THE_RIGHT_TOOLTIP,
    TR_BUILDING_INFO_CARAVANSERAI_MONTHLY_CONSUMPTION,
    TR_CONFIG_CARAVANS_MOVE_OFF_ROAD,
    TR_CONFIG_CARAVANS_MOVE_OFF_ROAD_TOOLTIP,
    ...
    TR_CONFIG_STORAGE_STEP_4_TOOLTIP,
    ...
    TR_CONFIG_PATRICIAN_DEVOLUTION_FIX_TOOLTIP,
    ...
    TR_CONFIG_DEFAULT_GAME_SPEED_TOOLTIP,
    ...
    TR_CONFIG_SHOW_CUSTOM_VARIABLES_TOOLTIP,
    ...
    TR_CONFIG_ENABLE_GETTING_WHILE_STOCKPILED_TOOLTIP,
    TR_CONFIG_ENABLE_PAVED_ROADS_NEAR_GRANARIES,
    TR_CONFIG_ENABLE_PAVED_ROADS_NEAR_GRANARIES_TOOLTIP,
    TR_CONFIG_UI_ANIMATE_TRADE_ROUTES,
    TR_CONFIG_UI_ANIMATE_TRADE_ROUTES_TOOLTIP,
    TR_HOTKEY_NEXT_TRACK,
    TR_CONFIG_MOVE_LEGION_SOUND_SWAP,
    TR_CONFIG_MOVE_LEGION_SOUND_SWAP_TOOLTIP,
    ...
    TR_CONFIG_ADVANCED_CART_DEPOT_OPTIONS_TOOLTIP,
    ...
    TR_CONFIG_CLEAR_WARNINGS_RIGHTCLICK_TOOLTIP,
    TR_CONFIG_GP_CH_STORAGE_REQUESTS_RESPECT_MAINTAIN,
    TR_CONFIG_GP_CH_STORAGE_REQUESTS_RESPECT_MAINTAIN_TOOLTIP,
    TR_CONFIG_ENABLE_MARKET_RANGE,
    TR_CONFIG_ENABLE_MARKET_RANGE_TOOLTIP,
    ...
    TR_CONFIG_UI_CV_BUILD_MENU_ICONS_TOOLTIP,
    ...
    TR_CONFIG_UI_CV_CURSOR_SHADOW_TOOLTIP,
    ...
    TR_CONFIG_GP_CH_HOUSING_PRE_MERGE_VACANT_LOTS_TOOLTIP,
    ...
    TR_CONFIG_UI_BUILD_SHOW_RESERVOIR_RANGES_TOOLTIP,
    TR_CONFIG_GP_CH_ALWAYS_DESTROY_BRIDGES,
    TR_CONFIG_GP_CH_ALWAYS_DESTROY_BRIDGES_TOOLTIP,
    ...
    TR_CONFIG_ENABLE_BUILD_MENU_SHORTCUTS_TOOLTIP,
    ...
    TR_CONFIG_GRANARY_DEFAULT_TO_PASS_ALL_WALKERS_TOOLTIP,
    TR_CONFIG_WAREHOUSE_DEFAULT_TO_PASS_ALL_WALKERS,
    TR_CONFIG_WAREHOUSE_DEFAULT_TO_PASS_ALL_WALKERS_TOOLTIP,
    ...
    TR_CONFIG_SHOW_SHORELINE_DESIRABILITY_TOOLTIP,
    TR_CONFIG_SHOW_ELEVATION_DESIRABILITY,
    TR_CONFIG_SHOW_ELEVATION_DESIRABILITY_TOOLTIP,
