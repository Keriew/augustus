...
#define MAX_BUILDINGS_PER_ORIGINAL_ALLOWED_SLOT 13
...
static const building_type CONVERSION_FROM_ORIGINAL[MAX_ORIGINAL_ALLOWED_BUILDINGS][MAX_BUILDINGS_PER_ORIGINAL_ALLOWED_SLOT] = {
    { BUILDING_NONE },
    { BUILDING_MENU_FARMS, BUILDING_WHEAT_FARM, BUILDING_VEGETABLE_FARM, BUILDING_FRUIT_FARM, BUILDING_OLIVE_FARM, BUILDING_VINES_FARM, BUILDING_PIG_FARM },
    { BUILDING_MENU_RAW_MATERIALS, BUILDING_CLAY_PIT, BUILDING_MARBLE_QUARRY, BUILDING_IRON_MINE, BUILDING_TIMBER_YARD, BUILDING_GOLD_MINE, BUILDING_STONE_QUARRY, BUILDING_SAND_PIT },
    { BUILDING_MENU_WORKSHOPS, BUILDING_WINE_WORKSHOP, BUILDING_OIL_WORKSHOP, BUILDING_WEAPONS_WORKSHOP, BUILDING_FURNITURE_WORKSHOP, BUILDING_POTTERY_WORKSHOP, BUILDING_BRICKWORKS, BUILDING_CONCRETE_MAKER },
    { BUILDING_ROAD },
    ...
    { BUILDING_GARDENS, BUILDING_OVERGROWN_GARDENS, BUILDING_MENU_TREES, BUILDING_MENU_PATHS, BUILDING_HEDGE_DARK, BUILDING_HEDGE_LIGHT, BUILDING_PAVILION_BLUE, BUILDING_COLONNADE, BUILDING_LOOPED_GARDEN_WALL, BUILDING_ROOFED_GARDEN_WALL, BUILDING_DECORATIVE_COLUMN },
    { BUILDING_PLAZA },
    { BUILDING_SMALL_STATUE, BUILDING_SMALL_STATUE_ALT, BUILDING_SMALL_STATUE_ALT_B, BUILDING_GLADIATOR_STATUE, BUILDING_MEDIUM_STATUE, BUILDING_LEGION_STATUE, BUILDING_LARGE_STATUE, BUILDING_HORSE_STATUE, BUILDING_OBELISK, BUILDING_SMALL_POND, BUILDING_LARGE_POND, BUILDING_MENU_STATUES },
    { BUILDING_DOCTOR },
    { BUILDING_HOSPITAL },
    { BUILDING_BATHHOUSE },
    { BUILDING_BARBER },
    ...
    { BUILDING_MENU_SMALL_TEMPLES, BUILDING_SMALL_TEMPLE_CERES, BUILDING_SMALL_TEMPLE_NEPTUNE, BUILDING_SMALL_TEMPLE_MERCURY, BUILDING_SMALL_TEMPLE_MARS, BUILDING_SMALL_TEMPLE_VENUS },
    { BUILDING_MENU_LARGE_TEMPLES, BUILDING_LARGE_TEMPLE_CERES, BUILDING_LARGE_TEMPLE_NEPTUNE, BUILDING_LARGE_TEMPLE_MERCURY, BUILDING_LARGE_TEMPLE_MARS, BUILDING_LARGE_TEMPLE_VENUS, BUILDING_MENU_GRAND_TEMPLES },
    { BUILDING_MARKET },
    { BUILDING_GRANARY },
    { BUILDING_WAREHOUSE },
