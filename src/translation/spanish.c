...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_TITLE, "Opciones de configuración de Claudius"},
    ...
    {TR_HOTKEY_TITLE, "Configuración de atajos de teclado de Claudius"},																																					   
    ...
    {TR_NO_EXTRA_ASSETS_MESSAGE,
        "Los recursos adicionales de Claudius no pudieron cargarse.\n"
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "La partida guardada que estás intentando cargar es para una versión más reciente de Claudius.\nActualiza Claudius a la versión más reciente." },
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "Por favor, consulte claudius-log.txt en su directorio Claudius para más detalles."},
    ...
    {TR_EDITOR_CHECK_LOG_MESSAGE, "Por favor, consulte claudius-log.txt en su directorio de Claudius para más detalles."},
