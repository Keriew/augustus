...
static translation_string all_strings[] = {
    ...
    {TR_SAVEGAME_MOD_MISMATCH_TITLE, "Mod mismatch detected" },
    {TR_SAVEGAME_MOD_MISMATCH_MESSAGE, "This .savf file was created with a different active mod. Vespasian will continue loading it, but data-driven behavior may differ." },
