...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_TITLE, "Claudius-konfigurationer"},
    ...
    {TR_HOTKEY_TITLE, "Claudius kortkommandoinställningar"},
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "Sparfilen du försöker ladda är från en nyare version av Claudius.\nVar god uppdatera Claudius till den senaste versionen." },
...
,    {TR_CONFIG_DEFAULT_PLAYER_NAME, "Standardspelarnamn:"},
    ...
    {TR_WINDOW_INVALID_CAMPAIGN_TEXT, "Den valda kampanjfilen är ogiltig.\\nVar god och läs claudius-log.txt i din Claudius-mapp ([...]\\AppData\\Roaming\\claudius) för mer detaljer."},
