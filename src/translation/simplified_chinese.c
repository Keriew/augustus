...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_AUTO_KILL_ANIMALS, "居民将自发捕杀无害动物。"},
    ...
    {TR_BUILDING_CARAVANSERAI_PHASE_2_TEXT, "工程师正在建造方形立柱，里面将成为贸易者以及他们携带动物的休憩场所。Inside will be shelters for traders and their animals."},
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_3, "陆地种类导向型政策：商队携带额外4种贸易物资，但商队旅站的食物消耗量增加20%。"},
    ...
    {TR_BUILDING_BRICKWORKS_STORED_SAND, "存储石料："},
