...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_CERES_MODULE_3_DESC, "Farm carts from food farms move much faster." },
    {TR_BUILDING_GRAND_TEMPLE_CERES_DESC_MODULE_4, "Temple of Ceres Abundantia" },
    {TR_BUILDING_GRAND_TEMPLE_CERES_MODULE_4_DESC, "Market buyers collecting from granaries and warehouses move faster." },
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_DESC_MODULE_3, "Temple of Mercury Mercator" },
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_MODULE_3_DESC, "Land traders and caravans move faster and carry more goods." },
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_DESC_MODULE_4, "Temple of Mercury Opulentus" },
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_MODULE_4_DESC, "Goods consumption is reduced citywide based on Prosperity." },
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_DESC_MODULE_3, "Temple of Neptunus Adiutor" },
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_MODULE_3_DESC, "Fountain and reservoir range is increased." },
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_DESC_MODULE_4, "Temple of Neptunus Redux" },
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_MODULE_4_DESC, "Sea traders move faster and carry more goods." },
    {TR_BUILDING_PANTHEON_DESC_MODULE_1, "Pantheum Ara Maxima" },
    {TR_BUILDING_PANTHEON_DESC_MODULE_2, "Pantheum Roma Aeterna" },
    {TR_BUILDING_PANTHEON_DESC_MODULE_3, "Pantheum Imperatorum" },
    {TR_BUILDING_PANTHEON_MODULE_3_DESC, "The Senate also sends a priest of the Pantheon, conveying all of its benefits." },
    {TR_BUILDING_PANTHEON_DESC_MODULE_4, "Pantheum Auratum" },
    {TR_BUILDING_PANTHEON_MODULE_4_DESC, "Luxury palaces house more residents, contribute additional workers to the city, and each grant 2 culture rating." },
    {TR_BUILDING_GRAND_TEMPLE_MARS_DESC_MODULE_3, "Temple of Mars Gradivus" },
    {TR_BUILDING_GRAND_TEMPLE_MARS_MODULE_3_DESC, "Cartpushers supplying workshops move faster. Legionaries march faster for each food type provided at the supply post." },
    {TR_BUILDING_GRAND_TEMPLE_MARS_DESC_MODULE_4, "Temple of Mars Invictus" },
    {TR_BUILDING_GRAND_TEMPLE_MARS_MODULE_4_DESC, "Barracks train troops faster for each food type provided at the supply post. Military victories grant a temporary boost to sentiment." },
