...
static translation_string all_strings[] = {
    ...
    {TR_NO_EXTRA_ASSETS_MESSAGE, "无法加载Claudius资源。\n"
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "请在claudius目录中查看claudius-log.txt获取详细信息"},
    ...
    {TR_WINDOW_INVALID_CAMPAIGN_TEXT, "战役文件无效。\n请进入Claudius目录检查claudius-log.txt日志查看详细信息。"},
    ...
    {TR_USER_DIRECTORIES_NOT_SET_UP_TITLE, "没有设置Claudius玩家目录"},
    {TR_USER_DIRECTORIES_NOT_SET_UP_TEXT, "你还没有设置Claudius玩家目录（游戏存档、自定义场景和地图会保存在这里）。\n"
                                          "现在进行设置？"},
    {TR_USER_DIRECTORIES_CANCELLED_TITLE, "取消设置用户文件夹"},
    {TR_USER_DIRECTORIES_CANCELLED_TEXT, "由于没有设置Claudius玩家目录，默认使用C3游戏目录。\n"
                                         "之后可以在游戏设置再进行设置。"},
    ...
    {TR_USER_DIRETORIES_WINDOW_USER_PATH, "Claudius玩家目录"},
    {TR_USER_DIRECTORIES_USER_PATH_CHANGED_TITLE, "Claudius玩家目录已变更"},
    {TR_USER_DIRECTORIES_USER_PATH_CHANGED_TEXT, "成功修改Claudius玩家目录。立即复制所有文件？"},
