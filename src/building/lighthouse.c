...
int building_lighthouse_get_storage_destination(building *lighthouse)
{
    ...
    if (!building_distribution_get_raw_material_storages(data, BUILDING_LIGHTHOUSE, lighthouse->road_network_id,
        lighthouse->road_access_x, lighthouse->road_access_y, INFINITE)) {
        return 0;
    }
